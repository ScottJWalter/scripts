...
> اضغط على الصورة لمشاهدة المقطع على اليوتيوب
# ChatPDF Bot
...
[ اضغط هنا للإطلاع على احدث إصدار مباشرة](https://github.com/bidjadraft/Termux/releases/tag/chatpdf)
---
3. قم بتحميل أحدث إصدار من ملف [ChatPDF.txt](https://github.com/bidjadraft/Termux/releases/download/chatpdf/ChatPDF.txt) ثم افتحه على أي برنامج ، انسخ كل محتواه و الصقه في محرر النصوص على ترمكس
---
...
10.  إذا أردت إيقاف الكود أو البوت اضغط على `Cntrl` + `C`
---
